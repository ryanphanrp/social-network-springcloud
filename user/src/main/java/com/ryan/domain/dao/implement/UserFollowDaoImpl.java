...
public class UserFollowDaoImpl implements UserFollowDao {
  ...
  public UserFollowDetail getUserFollowDetail(Long userId) {
    ...
    Long fromUserCount = result.get("from_user_count", Long.class);
    Long toUserCount = result.get("to_user_count", Long.class);
    return UserFollowDetail.builder()
            .followers(toUserCount)
            .following(fromUserCount)
            .build();
  }
}
